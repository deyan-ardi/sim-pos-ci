...
function collapsehover() {
  if (1 == $(".pcoded-navbar").hasClass("navbar-collapsed")) {
    smmenu($(".pcoded-navbar.navbar-collapsed"));
  }
}
function smmenu(e) {
  e.off("click")
    ...
    .hover(
      function () {
        $(".pcoded-navbar.navbar-collapsed:not(.theme-horizontal)")
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        (document.getElementsByClassName("rem-msg")[0].innerHTML =
          "<p class='chat-cont'>hello dear you write</p> <p class='chat-cont'>" +
          e +
          "</p>"),
  ...
  if (
    ...
    $("#m-search").on("keyup", function () {
      ...
      $(".pcoded-inner-navbar > li").each(function () {
        var s = $(this).attr("data-username");
        // console.log(s);
        if (s) var d = s.toLowerCase();
        if (d) {
    ...
    $(".h-send-chat").on("keyup", function (o) {
      e(o);
    }),
...
if (
    ...
    var o =
      ...
      s = {
        PcodedMenuInit: function () {
          s.HandleMenuTrigger(), s.HandleSubMenuTrigger(), s.HandleOffset();
        },
        HandleSubMenuTrigger: function () {
          ...
          if (
            ...
            if (
              (s >= 992 && $("body").hasClass("layout-6")) ||
              (s >= 992 && $("body").hasClass("layout-7"))
            ) {
              var d = $(
        ...
        HandleMenuTrigger: function () {
          ...
          if (s >= 992) {
            if (1 == $(".pcoded-navbar").hasClass("theme-horizontal"))
              if (
                (s >= 768 && $("body").hasClass("layout-6")) ||
                (s >= 768 && $("body").hasClass("layout-7"))
              ) {
                var d = $(
                    ...
                    function () {
                      if (
                        ...
                        if (s + d <= $(window).width())
                          ...
                          $(".sidenav-inner").css({
                            "margin-left":
                              parseInt(a.slice(12, a.length - 3)) - 80,
                          }),
  ...
  $("#mobile-collapse1").click(function (e) {
    ...
    ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) &&
      setTimeout(function () {
        o <= 992 &&
          $(".pcoded-navbar:not(.theme-horizontal-dis)").removeClass(
            "mob-open"
          ),
          o > 992 &&
...
$(".pcoded-main-container,.pcoded-header,.pcoded-navbar.theme-horizontal").on(
  "click",
  function () {
    var e = $(window)[0].innerWidth;
    ($("body").hasClass("layout-6") || $("body").hasClass("layout-7")) &&
  ...
  $(document).mouseup(function (e) {
    var o = $("body.layout-8 .pcoded-navbar .dropdown-menu");
  ...
  $(".layout-9 .sidemenu a").on("click", function () {
    ...
    e.parents("li").siblings().removeClass("active"),
      ...
      $(".side-content .sidelink." + e.attr("data-cont")).slideDown(1);
  });
var vw = $(window)[0].innerWidth;
if (
  (vw < 992 &&
    ($(".page-wrapper>.page-header")[0]
      ? ($(".pcoded-header > .collapse:not(.show)>.mr-auto").css(
          "display",
          "none"
        ),
        $(".pcoded-header > .collapse:not(.show)>.ml-auto").css(
          "display",
          "block"
        ),
        $(".pcoded-header > .container> .collapse:not(.show)>.mr-auto").css(
          "display",
          "none"
        ),
        $(".pcoded-header > .container> .collapse:not(.show)>.ml-auto").css(
          "display",
          "block"
        ),
        $(".pcoded-header > .container> .collapse")[0] &&
          (console.log("hii"),
          $(".pcoded-header > .container> .collapse:not(.show)").append(
            '<a href="#!" class="mob-toggler"></a>'
          )))
      : $(".pcoded-header > .collapse:not(.show)").append(
          '<a href="#!" class="mob-toggler"></a>'
        )),
...
$(".pcoded-header > .collapse:not(.show) .mob-toggler").click(function () {
  ...
  $(".pcoded-header > .container>.collapse:not(.show) .mob-toggler").click(
    function () {
      $(".pcoded-header > .container> .collapse:not(.show) > ul").slideToggle(
        1
      );
    }
  ),
  ...
  $(".layout-14 .pcoded-inner-navbar > li.pcoded-hasmenu").on(
    "mouseenter",
    function () {
      if (vw >= 992) {
        clrpop(),
        ...
        var e = $(this),
          o = $(".navbar-popup"),
          s = e.children(".pcoded-submenu").clone();
        o.addClass("pcoded-inner-navbar"), o.html(s);
        var d = $(e, this),
          a = d.offset(),
          i = (a.left, a.top),
        ...
        o.show(),
          console.log(t),
          n <= i + r - t
            ? (o.addClass("vedge"), o.animate({ top: i - 240 - t }, 1))
            : (o.removeClass("vedge"), o.animate({ top: i - 8 - t }, 1)),
  ...
  $(".layout-14 .pcoded-inner-navbar > li:not(.pcoded-hasmenu)").on(
    "mouseenter",
    function () {
      clrpop();
    }
  ...
  $(".pcoded-navbar .pcoded-inner-navbar a").each(function () {
    ...
    if (
      ...
      var o = $(".sidelink.active").attr("class");
      (o = o.replace("sidelink", "")),
        (o = o.replace("active", "")),
        $(".sidemenu  .nav-link[data-cont=" + o.trim() + "]")
          .parent()
          .addClass("active");
    }
  });
$(document).ready(function () {
  ...
  if (success) {
    swal("Query Berhasil!", success, "success");
  }
});
$(document).ready(function () {
  const gagal = $(".gagal").data("gagal");
  if (gagal) {
    swal("Terjadi Kesalahan!", gagal, "error");
  }
});
