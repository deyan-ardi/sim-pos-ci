...
<head>
    <meta charset="utf-8">
    <title>Lapoan Transaksi Barang Terjual</title>
    <style>
        @page {
            margin-top: 70px;
            margin-bottom: 70px;
...
<body>
    ...
    <footer>
        <p style="font-size:9px;padding-bottom:20px">===============================================================================================================</p>
        <p style="font-size:9px"><i>Laporan Transaksi Barang Terjual Ini Sah Dicetak dan Dikeluarkan Oleh PT DAPUR INSPIRASI NUSANTARA</i></p>
                ...
                <td class="w-50 text-left">
                    ...
                    <table class="w-100" style="padding-top:20 ;">
                        <tr>
                            ...
                            <td>
                                <p style="font-size:12px">: <?= date('Hi') . "/BARANG-TERJUAL/" . date('Ymd') ?></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="120px">
                        ...
                        <tr>
                            ...
                            <td>
                                <p style="font-size:12px">: Laporan Barang Terjual</p>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <thead>
                    <tr>
                        ...
                        <td style="background-color:#7460ee;vertical-align: middle;" width="160px" class="text-right">
                            <h5 style="color:#ffffff;font-size:12px">Tanggal Keluar</h5>
                        </td>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php if (empty($barang)) : ?>
                        <tr>
                            <td colspan="10" style="text-align: center;">
                                <p style="font-size:12px">Tidak Ada Barang Keluar</p>
                            </td>
                        </tr>
                    <?php else : ?>
                        <?php foreach ($barang as $d) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p style="font-size:11px;color:#28a745">Sukses</p>
                                </td>
                                <td>
                                    <p style="font-size:11px;"><?= $d->username; ?></p>
                                </td>
                                <td class="text-right">
                                    <p style="font-size:11px;"><?= CodeIgniter\I18n\Time::parse($d->updated_at)->humanize(); ?></p>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                    ...
                    <tr style="background-color:whitesmoke">
                        <td class="text-right" colspan="7">
                            <p style="font-size:11px">TOTAL ITEM DIBELI</p>
                        </td>
                    ...
                    <tr style="background-color:whitesmoke">
                        <td class="text-right" colspan="7">
                            <p style="font-size:11px">TOTAL JUMLAH TERJUAL</p>
                        </td>
                        <td class="text-right" colspan="3">
