                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form action="" method="POST">
                                                                                    ...
                                                                                    <input type="hidden"
                                                                                        ...
                                                                                        value="<?= $c->id; ?>">
                                                                                    <input type="text"
                                                                                        class="form-control <?= $validation->getError('category_update') ? "is-invalid" : ""; ?>"
                                                                                        style="text-transform: capitalize;"
                                                                                        name="category_update"
                                                                                        placeholder="Category Name"
                                                                                        value="<?= (old('category_update')) ? old('category_update') : $c->category_name ; ?>">
            ...
            <div class="modal-body">
                <form action="" method="POST">
                    ...
                    <input type="text"
                        ...
                        style="text-transform: capitalize;" name="category" required placeholder="Category Name"
