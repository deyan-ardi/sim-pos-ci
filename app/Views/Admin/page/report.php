                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Dintara Point Of Sale - Laporan Transaksi</h5>
                                        </div>
                                        <ul class="breadcrumb">
                                                            ...
                                                            <td>
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <form action="" method="POST">
                                                                        ...
                                                                        <input type="hidden" name="id_transaksi" value="<?= $t->sale_code; ?>">
                                                                        <button type="submit" name="delete_transaksi" value="delete" class="btn btn-danger btn-icon btn-rounded" title="Hapus Transaksi" data-toggle="tooltip"><i class="feather icon-trash"></i></button>
                                                                    </form>
