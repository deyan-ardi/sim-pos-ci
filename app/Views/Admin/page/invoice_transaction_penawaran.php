...
<body>
    <header class="clearfix">
        <h1>KODE PENAWARAN <?= $sale[0]->penawaran_code; ?></h1>
        <table id="info">
            <tr>
                <td id="company">
                    <div>
                        ...
                        <div>Jenis Transaksi : Transaksi <?= $sale[0]->penawaran_ket; ?></div>
                    </div>
                </td>
                <td id="project">
                    <div>
                        ...
                        <?php if ($sale[0]->penawaran_ket == 'project') : ?>
        ...
        <table id="output">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="total">Rp. <?= format_rupiah($sale[0]->penawaran_handling); ?></td>
                </tr>
                <tr>
                    <td colspan="5">SUB TOTAL III</td>
                    <td class="total">Rp. <?= format_rupiah($sub_tot_2 + $sale[0]->penawaran_handling); ?></td>
                </tr>
                <tr>
                    <td colspan="5">PPh</td>
                ...
                <tr>
                    ...
                    <td class="grand total">Rp. <?= format_rupiah($sale[0]->penawaran_total); ?></td>
                </tr>
            </tbody>
        </table>
        <div id="notices">
