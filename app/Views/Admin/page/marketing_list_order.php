                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Dintara Point Of Sale - List Order Barang Supplier</h5>
                                        </div>
                                        <ul class="breadcrumb">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($order as $c) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $c->username ?></td>
                                                            <td><a href="<?= base_url(); ?>/marketing/list_orders?order_code=<?= $c->order_code; ?>" class="btn btn-info"><i class="feather icon-shopping-cart"></i> Lihat Pesanan</a></td>
                                                            <td>
