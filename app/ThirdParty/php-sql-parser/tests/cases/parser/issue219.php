 ...
 * @internal
 */
final class issue219 extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testIssu219()
    {
        ...
        $expected = getExpectedValue(__DIR__, 'issue219.serialized', false);
        $this->assertSame($expected, serialize($parsed));
    }
}
